...
const techRow1 = [
  ...
  { name: "Three.js", icon: layers => <Layers className="w-4 h-4" /> },
  { name: "WebGL", icon: Cpu },
];
        ...
        {[...items, ...items, ...items].map((tech, i) => (
          ...
          >
             <div className="skew-x-[10deg] flex items-center gap-3">
               {typeof tech.icon === 'function' ? tech.icon({}) : <tech.icon className="w-4 h-4 text-gray-400 group-hover:text-premium-green transition-colors" />}
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="border-t border-white/5 pt-20 relative">
           <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-premium-black px-4 flex items-center gap-2">
               ...
               <span className="text-xs text-premium-green font-bold uppercase tracking-[0.2em]">Architecture System</span>
           </div>
