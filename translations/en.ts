export const en = {
    ...
    valueTrifecta: {
        ...
        services: {
            design: {
                ...
                description: "We don't just draw pages, we create universes. Every pixel is intentional, every animation tells a story.",
                items: ["High-End UI/UX", "Art Direction", "Motion Design (GSAP)", "3D Modeling / WebGL", "Sound Branding"]
            },
            engineering: {
                title: "Engineering & Code",
                description: "An invisible but invincible architecture. We develop solid foundations to support your exponential growth.",
                items: ["Next.js 14 / React", "Headless Architecture", "GLSL Shaders", "Rest / GraphQL API", "Advanced Cybersecurity"]
            },
            growth: {
                title: "Growth & Data",
                description: "The art of scientific selling. We connect your platform to the most powerful tools to track and maximize ROI.",
                items: ["Technical SEO", "Server-side Tracking", "A/B Testing", "CRO (Conversion)", "Analytics Dashboards"]
            }
        },
        revenue: "Revenue",
    ...
    offer: {
        ...
        title: "Investment.",
        subtitle: "Three levels of excellence to propel your business. No hidden costs.",
        ...
        faqItems: {
            delays: {
                ...
                starter: "7 business days.",
                business: "14 business days.",
                empire: "3-5 weeks."
            },
            payment: {
                title: "Installment payment?",
                answer: "Yes. 50% deposit at project launch, and the remaining 50% upon final delivery."
            }
        },
        customProject: {
    ...
    footer: {
        ...
        ctaLink: "Let's talk about your future site.",
