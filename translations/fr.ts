export const fr = {
    ...
    valueTrifecta: {
        ...
        subtitle: "Nous avons banni le médiocre. Chaque pixel, chaque ligne de code et chaque animation sert un but unique : la domination de votre marché.",
        arsenal: "L'arsenal tactique",
    ...
    offer: {
        ...
        subtitle: "Trois niveaux d'excellence pour propulser votre business. Pas de coûts cachés.",
        ...
        faqItems: {
            delays: {
                ...
                starter: "7 jours ouvrés.",
                business: "14 jours ouvrés.",
                empire: "3-5 semaines."
            },
            payment: {
    ...
    contact: {
        ...
        availabilityHours: "Lun - Ven : 9h - 18h",
        form: {
            name: "Nom",
            company: "Entreprise",
            email: "Email",
            budget: "Budget estimé",
            budgetOptions: ["Fondation — 950 €", "Stratégie — 1 650 €", "Signature — 2 950 €", "Montant personnalisé"],
    ...
    // Footer
    footer: {
        cta: "Prêt à passer au niveau supérieur ?",
        ctaLink: "Parlons de votre futur site.",
    ...
    pricingPage: {
        ...
        faqs: [
            { question: "Quels sont les délais de livraison ?", answer: "Fondation : 7 jours ouvrés. Stratégie : 14 jours ouvrés. Signature : 3-5 semaines selon la complexité." },
    ...
    contactPage: {
        ...
        emailTitle: "contact@osiris-agency.fr",
