                ...
                <div className="container mx-auto max-w-4xl relative z-10">
                    ...
                    <nav className="mb-10 flex flex-wrap gap-3 justify-center">
                        {[
                            ...
                            <a
                                key={href}
                                href={href}
                                className="text-sm px-4 py-2 rounded-full border border-[#2A3140] text-gray-400 hover:border-premium-green hover:text-premium-green transition-colors"
                            >
                                {label}
                            </a>
                        ))}
                    ...
                    <div className="space-y-12 sm:space-y-16">
                        ...
                        <div id="mentions" className="scroll-mt-32">
                            <h2 className="text-3xl font-bold text-white mb-8 border-b border-[#2A3140] pb-4 font-display">1. Mentions légales</h2>
                            <div className="bg-[#1B202B] border border-[#2A3140] rounded-2xl p-8 space-y-2 text-gray-400 leading-relaxed">
                                ...
                                <p className="pt-4 border-t border-[#2A3140]/50"><strong className="text-white">Hébergeur :</strong> Vercel Inc. — 340 Pine Street, Suite 701, San Francisco, CA 94104, États-Unis.<br />
                        ...
                        <div id="cgv" className="scroll-mt-32">
                            <h2 className="text-3xl font-bold text-white mb-8 border-b border-[#2A3140] pb-4 font-display">2. Conditions Générales de Vente (CGV)</h2>
                            <div className="space-y-8">
                                <div className="bg-[#1B202B] border border-[#2A3140] rounded-2xl p-8">
                        ...
                        <div id="confidentialite" className="scroll-mt-32">
                            <h2 className="text-3xl font-bold text-white mb-8 border-b border-[#2A3140] pb-4 font-display">3. Politique de Confidentialité (RGPD)</h2>
                            <div className="space-y-8">
                                <div className="bg-[#1B202B] border border-[#2A3140] rounded-2xl p-8">
                        ...
                        <div id="cookies" className="scroll-mt-32">
                            <h2 className="text-3xl font-bold text-white mb-8 border-b border-[#2A3140] pb-4 font-display">4. Politique de Cookies</h2>
                            <div className="space-y-8">
                                <div className="bg-[#1B202B] border border-[#2A3140] rounded-2xl p-8">
                                ...
                                <div className="bg-[#1B202B] border border-[#2A3140] rounded-2xl p-8 overflow-x-auto">
