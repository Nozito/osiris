    ...
    return (
        <div className="min-h-screen bg-transparent selection:bg-premium-green selection:text-white overflow-hidden font-sans">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] bg-transparent" />
                <div className="absolute bottom-[-20%] right-[-10%] w-[50vw] h-[50vw] bg-transparent" />
            </div>
            ...
            <div className="relative z-10 pt-24 sm:pt-28 pb-10 sm:pb-14 px-4 sm:px-6">
                <div className="container mx-auto max-w-5xl">
                    ...
                    >
                        <Link to="/" className="inline-flex items-center gap-2 text-gray-500 hover:text-[#0F1729] transition-colors mb-5 text-xs font-mono uppercase tracking-widest group">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
                            <div>
                                ...
                                <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold font-display italic text-[#0F1729] tracking-tight leading-tight">
                                    {t.contactPage.title}
                            ...
                            <p className="text-[#0F1729]/50 text-sm leading-relaxed sm:text-right sm:max-w-xs border-l-2 sm:border-l-0 sm:border-r-2 border-premium-green/30 pl-3 sm:pl-0 sm:pr-4 text-xs sm:text-sm">
                                {t.contactPage.subtitle}<br />
                                <span className="text-[#0F1729] font-medium">{t.contactPage.subtitleHighlight}</span>
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 lg:gap-4">
                                <div className="group p-4 lg:p-5 rounded-2xl bg-white border border-[#E8E3D9] hover:border-premium-green/40 hover:bg-[#FDFCFA] transition-all duration-300">
                                    <div className="flex flex-col sm:flex-row items-start gap-3 lg:gap-4">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <h3 className="text-[#0F1729] font-bold text-xs sm:text-sm truncate">
                                ...
                                <div className="group p-4 lg:p-5 rounded-2xl bg-white border border-[#E8E3D9] hover:border-premium-green/40 hover:bg-[#FDFCFA] transition-all duration-300">
                                    <div className="flex flex-col sm:flex-row items-start gap-3 lg:gap-4">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <h3 className="text-[#0F1729] font-bold text-xs sm:text-sm mb-0.5">{t.contactPage.availabilityTitle}</h3>
                                            <p className="text-[#0F1729] font-mono text-[10px] sm:text-xs">{t.contactPage.availabilityHours}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-4 sm:p-5 rounded-2xl border border-premium-green/25 bg-gradient-to-br from-premium-green/8 via-premium-green/4 to-transparent relative overflow-hidden">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <span className="text-[#0F1729] text-sm font-bold block mb-1">{language === 'fr' ? 'Réponse garantie sous 24h' : 'Reply guaranteed within 24h'}</span>
                            ...
                            {/* Google Maps */}
                            <div className="rounded-2xl overflow-hidden border border-[#E8E3D9] shadow-[0_4px_16px_rgba(15,23,41,0.06)]">
                                <iframe
                        ...
                        <div className="lg:col-span-3 relative order-1 lg:order-2">
                            ...
                            <motion.div
                                ...
                                className="relative bg-white border border-[#E8E3D9] rounded-2xl p-5 sm:p-7 overflow-hidden"
                            >
                                <div className="absolute inset-0 border border-[#E8E3D9] rounded-2xl pointer-events-none" />
                                ...
                                <AnimatePresence mode="wait">
                                    {formStatus === 'success' ? (
                                        ...
                                        >
                                            ...
                                            <h3 className="text-2xl font-bold text-[#0F1729] font-display mb-2">{t.contactPage.successTitle}</h3>
                                        ...
                                        >
                                            {/* Form header */}
                                            <div className="flex items-center gap-3 mb-5 pb-4 border-b border-[#E8E3D9]">
                                                <div className="w-8 h-8 rounded-lg bg-premium-green/10 flex items-center justify-center text-premium-green">
                                                    <MessageSquare className="w-4 h-4" />
                                                </div>
                                                <h3 className="text-base font-bold text-[#0F1729] font-display uppercase tracking-wider">{t.contactPage.formTitle}</h3>
                                            </div>

                                            {/* Name + Company row */}
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div className="space-y-1.5 group">
                                                    <label htmlFor="cp-name" className="text-[10px] uppercase tracking-widest text-[#0F1729]/50 font-bold block group-focus-within:text-premium-green transition-colors duration-200">{t.contactPage.labelName}</label>
                                                    <input
                                                        id="cp-name" name="name" required type="text"
                                                        className="w-full bg-white border border-[#E8E3D9] rounded-lg px-3.5 py-2.5 text-[#0F1729] text-sm placeholder-[#0F1729]/30 focus:border-premium-green/50 focus:bg-white focus:outline-none transition-all duration-200 font-medium"
                                                        placeholder="Ex: John Doe"
                                                    />
                                                </div>
                                                <div className="space-y-1.5 group">
                                                    <label htmlFor="cp-company" className="text-[10px] uppercase tracking-widest text-[#0F1729]/50 font-bold block group-focus-within:text-premium-green transition-colors duration-200">{t.contactPage.labelCompany}</label>
                                                    <input
                                            ...
                                            {/* Email */}
                                            <div className="space-y-1.5 group">
                                                <label htmlFor="cp-email" className="text-[10px] uppercase tracking-widest text-[#0F1729]/50 font-bold block group-focus-within:text-premium-green transition-colors duration-200">{t.contactPage.labelEmail}</label>
                                                <div className="relative">
                                                    <input
                                                        id="cp-email" name="email" required type="email"
                                                        className="w-full bg-white border border-[#E8E3D9] rounded-lg px-3.5 py-2.5 pr-10 text-[#0F1729] text-sm placeholder-[#0F1729]/30 focus:border-premium-green/50 focus:bg-white focus:outline-none transition-all duration-200 font-medium"
                                                        placeholder="Ex: john@osiris.com"
                                                    />
                                                    <Mail className="absolute right-3.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#0F1729]/30 group-focus-within:text-premium-green transition-colors duration-200" />
                                                </div>
                                            </div>

                                            {/* Budget */}
                                            <div className="space-y-1.5 group">
                                                <label htmlFor="cp-budget" className="text-[10px] uppercase tracking-widest text-[#0F1729]/50 font-bold block group-focus-within:text-premium-green transition-colors duration-200">{t.contactPage.labelBudget}</label>
                                                <div className="relative">
                                                    <select
                                                        id="cp-budget" aria-label="Budget"
                                                        value={budgetSel}
                                                        onChange={e => setBudgetSel(e.target.value)}
                                                        className="w-full bg-[#F5F4EF] border border-[#E8E3D9] rounded-lg px-3.5 py-2.5 text-[#0F1729] text-sm focus:border-premium-green/50 focus:bg-white focus:outline-none transition-all duration-200 font-medium appearance-none cursor-pointer"
                                                    >
                                                        {t.contactPage.budgetOptions.map((option: string, i: number) => (
                                                            <option key={i} value={i < 3 ? option : 'custom'} className="bg-white text-[#0F1729]">{option}</option>
                                                        ))}
                                                    </select>
                                                    <ArrowRight className="absolute right-3.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#0F1729]/30 rotate-90 pointer-events-none" />
                                                </div>
                                                {budgetSel === 'custom' ? (
                                                    <input
                                                        name="budget"
                                            ...
                                            <div className="space-y-1.5 group">
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full bg-white border border-[#E8E3D9] rounded-lg px-3.5 py-2.5 text-[#0F1729] text-sm placeholder-[#0F1729]/30 focus:border-premium-green/50 focus:bg-white focus:outline-none transition-all duration-200 font-medium resize-none leading-relaxed"
